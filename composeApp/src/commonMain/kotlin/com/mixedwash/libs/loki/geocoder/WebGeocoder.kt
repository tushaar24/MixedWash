...
import com.mixedwash.libs.loki.geocoder.web.ForwardEndpoint
import com.mixedwash.libs.loki.geocoder.web.ForwardHttpApiPlatformGeocoder
import com.mixedwash.libs.loki.geocoder.web.HttpApiPlatformGeocoder
import com.mixedwash.libs.loki.geocoder.web.ReverseEndpoint
import com.mixedwash.libs.loki.geocoder.web.ReverseHttpApiPlatformGeocoder
...
): com.mixedwash.libs.loki.geocoder.Geocoder =
    _root_ide_package_.com.mixedwash.libs.loki.geocoder.Geocoder(
        platformGeocoder as com.mixedwash.libs.loki.geocoder.PlatformGeocoder,
        dispatcher
    )
...
public fun Geocoder(
    ...
    return _root_ide_package_.com.mixedwash.libs.loki.geocoder.Geocoder(apiGeocoder, dispatcher)
}
...
public fun ForwardGeocoder(
    ...
    httpClient: HttpClient = HttpApiEndpoint.httpClient(json),
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): _root_ide_package_.com.mixedwash.libs.loki.geocoder.ForwardGeocoder {
    return _root_ide_package_.com.mixedwash.libs.loki.geocoder.ForwardGeocoder(
...
public fun ReverseGeocoder(
    ...
    httpClient: HttpClient = HttpApiEndpoint.httpClient(json),
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): _root_ide_package_.com.mixedwash.libs.loki.geocoder.ReverseGeocoder {
    return _root_ide_package_.com.mixedwash.libs.loki.geocoder.ReverseGeocoder(
