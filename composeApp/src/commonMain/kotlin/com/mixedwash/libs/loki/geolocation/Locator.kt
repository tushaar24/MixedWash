...
import com.mixedwash.libs.loki.geolocation.exception.GeolocationException
...
public interface Locator {
     ...
     */
    public suspend fun current(priority: com.mixedwash.libs.loki.core.Priority = com.mixedwash.libs.loki.core.Priority.Balanced): Location
...
public object NotSupportedLocator : Locator {
    ...
    override suspend fun current(priority: com.mixedwash.libs.loki.core.Priority): Location = throw NotSupportedException()
