    ...
    .mapNotNull { (key, value) ->
        value?.let { nonNullValue ->
            when (nonNullValue) {
                ...
                is com.mixedwash.libs.loki.core.web.parameter.QueryParamValue -> key to nonNullValue.value
                is List<*> -> {
                    key to nonNullValue
                        .map { if (it is com.mixedwash.libs.loki.core.web.parameter.QueryParamValue) it.value else it.toString() }
