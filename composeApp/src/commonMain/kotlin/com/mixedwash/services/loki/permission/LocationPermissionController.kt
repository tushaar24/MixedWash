...
public interface LocationPermissionController {
     ...
     */
    public suspend fun requirePermissionFor(priority: com.mixedwash.services.loki.core.Priority): PermissionState
     ...
     */
    public suspend fun requirePermissionForOrThrow(priority: com.mixedwash.services.loki.core.Priority) {
