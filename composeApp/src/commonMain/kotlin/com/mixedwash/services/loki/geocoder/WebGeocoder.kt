package com.mixedwash.services.loki.geocoder
...
import com.mixedwash.services.loki.geocoder.web.ForwardEndpoint
import com.mixedwash.services.loki.geocoder.web.ForwardHttpApiPlatformGeocoder
...
import com.mixedwash.services.loki.geocoder.web.ReverseHttpApiPlatformGeocoder
...
): com.mixedwash.services.loki.geocoder.Geocoder =
    _root_ide_package_.com.mixedwash.services.loki.geocoder.Geocoder(
        platformGeocoder as com.mixedwash.services.loki.geocoder.PlatformGeocoder,
        dispatcher
    )
...
public fun Geocoder(
    ...
    return _root_ide_package_.com.mixedwash.services.loki.geocoder.Geocoder(apiGeocoder, dispatcher)
}
...
public fun ForwardGeocoder(
    ...
    httpClient: HttpClient = HttpApiEndpoint.httpClient(json),
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): _root_ide_package_.com.mixedwash.services.loki.geocoder.ForwardGeocoder {
    return _root_ide_package_.com.mixedwash.services.loki.geocoder.ForwardGeocoder(
        ForwardHttpApiPlatformGeocoder(endpoint, httpClient),
        dispatcher
    )
}
...
public fun ReverseGeocoder(
    ...
    httpClient: HttpClient = HttpApiEndpoint.httpClient(json),
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): _root_ide_package_.com.mixedwash.services.loki.geocoder.ReverseGeocoder {
    return _root_ide_package_.com.mixedwash.services.loki.geocoder.ReverseGeocoder(
        ReverseHttpApiPlatformGeocoder(endpoint, httpClient),
        dispatcher
    )
}
