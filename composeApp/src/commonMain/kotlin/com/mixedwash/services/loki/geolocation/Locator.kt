...
public interface Locator {
     ...
     */
    public suspend fun current(priority: com.mixedwash.services.loki.core.Priority = com.mixedwash.services.loki.core.Priority.Balanced): Location
...
public object NotSupportedLocator : Locator {
    ...
    override suspend fun current(priority: com.mixedwash.services.loki.core.Priority): Location = throw NotSupportedException()
