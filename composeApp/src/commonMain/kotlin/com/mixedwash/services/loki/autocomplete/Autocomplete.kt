...
): Autocomplete<T> = com.mixedwash.services.loki.autocomplete.internal.DefaultAutocomplete(
    service,
    options,
    dispatcher
)
...
public fun PlaceAutocomplete(
    ...
    options: AutocompleteOptions = AutocompleteOptions(),
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
): Autocomplete<Place> = com.mixedwash.services.loki.autocomplete.internal.DefaultAutocomplete(
    service,
    options,
    dispatcher
)