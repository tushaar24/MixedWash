...
import com.mixedwash.services.loki.geolocation.Locator
...
import com.mixedwash.services.loki.permission.exception.PermissionDeniedException
import com.mixedwash.services.loki.permission.exception.PermissionDeniedForeverException
import com.mixedwash.services.loki.permission.exception.PermissionException
...
internal class DefaultGeolocator(
    ...
    override suspend fun current(priority: com.mixedwash.services.loki.core.Priority): GeolocatorResult =
